...
class  hCard_widget extends WP_Widget {
    ...
    ?>
			...
			<div itemscope itemtype="http://schema.org" id="hcard" class="vcard <?php echo $main_class;?>">
				    <span itemprop="name" class="fn n <?php echo $name_class;?>">
					<a class="url" href="<?php echo $name_url;?>" itemprop="url"><span class="given-name <?php echo $given_name_class;?>"> <?php echo $given_name;?></span>
